...
The full-observed-period directional comparison below uses the $1{,}195$-post
low/high certainty-annotated dataset, with analysis-specific exclusions
described in Section~\ref{subsec:dataset}.
\textbf{[TODO: the majority--minority baseline and temporal trajectory figures
still use earlier annotation samples. Regenerate those analyses using the
low/high dataset and report their own contributing counts; do not relabel
legacy estimates as updated-sample results.]}
...
\paragraph{Directional certainty in low- and high-agreement posts.}
\label{subsec:res-certainty-contrasts}
Before examining temporal trajectories, we summarize expressed certainty
over the full observed period (Figure~\ref{fig:certainty-low-high}). In AITA
high-agreement posts, blaming dissent has a mean certainty of $3.564$,
compared with $3.488$ for defending dissent. The difference is modest on the
four-point scale: $0.075$ points ($95\%$ post-bootstrap CI
$[0.021,0.131]$), based on $506$ and $135$ contributing posts, respectively.
In low-agreement posts, the corresponding means are $3.669$ and $3.650$;
the difference of $0.018$ points ($[-0.012,0.050]$) remains uncertain,
with $134$ and $137$ contributing posts, respectively.

The certainty-$4$ proportion provides a complementary interpretation that
does not rely on the spacing between all four ordinal categories. In
high-agreement AITA posts, its post-averaged value is $66.1\%$ for blaming
and $58.1\%$ for defending dissent, a difference of $8.0$ percentage points
($95\%$ CI $[3.9,12.2]$). In low-agreement posts, the values are $71.7\%$
and $70.5\%$, with a difference of $1.2$ percentage points
($[-1.6,4.1]$). Thus, the annotated sample exhibits a modest directional
certainty difference within high-agreement AITA posts. Although the point
estimates of the directional gaps are larger under high agreement, the
separate intervals do not establish a direction-by-agreement interaction.

The high-agreement mean contrast also warrants annotation-version caution:
restricting AITA to \texttt{v4} gives a difference of $0.054$ points
($95\%$ CI $[-0.018,0.123]$). The positive point estimate remains, but its
interval includes zero. Version and post composition cannot be separated
because different posts received the two annotation versions. The first-18-hour
sensitivity analysis retains the positive high-agreement contrast
(Appendix~\ref{sec:appendix-certainty-window}). These aggregate summaries do
not establish that either direction becomes more certain over time or that
their certainty converges after 18 hours.

\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/certainty_direction_low_high_full_period.pdf}
  \caption{\textbf{Certainty of blaming and defending dissent in low- and
  high-agreement posts over the full observed period.}
  (A) Mean expressed certainty on the $1$--$4$ scale.
  (B) Blaming minus defending differences in mean certainty.
  (C) Differences in the mean within-post proportion of certainty-$4$
  comments, in percentage points; percentages below each estimate give
  blaming and defending values, respectively. Quantities are calculated
  within posts and then averaged with equal post weight. Bars show
  percentile $95\%$ confidence intervals from $10{,}000$ whole-post
  bootstrap replicates; B and C use intervals for the contrasts themselves.
  Low agreement is $0.40\le\rho(p)\le0.60$ with exact ties excluded;
  high agreement is $\rho(p)\le0.20$ or $\rho(p)\ge0.80$.
  Intermediate-agreement posts are omitted. Counts give contributing posts
  in blaming/defending order. Hollow markers flag the small AITAH
  high-agreement defending cohort ($15$ posts). AITA is discussed in RQ2
  and AITAH in RQ3; these are between-cohort descriptive contrasts.}
  \label{fig:certainty-low-high}
\end{figure*}

\paragraph{Joint share--certainty trajectories in high-agreement posts.}
The earlier high-agreement analysis used $604$ annotated posts, including
$402$ in AITA ($331$ NA-dominant and $71$ YA-dominant). These counts describe
the existing analysis, not the completed revised annotation dataset. Its arrival-window trajectories
...
answer; do not substitute the broader-sample findings.]}
...
Figure~\ref{fig:certainty-low-high} extends the same low/high comparison to
AITAH. In low-agreement posts, blaming and defending certainty average
$3.673$ and $3.609$, respectively, a difference of $0.064$ points
($95\%$ CI $[-0.001,0.128]$; $28$ and $30$ contributing posts).
In high-agreement posts, the means are $3.626$ and $3.505$, a difference of
$0.121$ points ($[0.022,0.228]$; $184$ and $15$ posts). The corresponding
certainty-$4$ proportion differences are $4.0$ percentage points
($[-1.2,9.0]$) under low agreement and $12.0$ percentage points
($[4.8,20.0]$) under high agreement. The high-agreement contrast is
particularly sensitive to the limited defending cohort: its interval
excluding zero does not remove the limitation of only $15$ posts. These
results neither establish a larger directional gap than in AITA nor show
that the gap persists across individual arrival windows.
...
\textbf{[TODO: update the directional window-specific share and joint
trajectory figures, with contributing counts and intervals. Keep those
temporal estimates distinct from the full-period summaries, and do not attribute
