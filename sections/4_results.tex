...
\textbf{[TODO: the certainty figures and associated findings in RQ2 and RQ3
still refer to the earlier annotation sample. Regenerate them using the
completed stratified annotation dataset (1,195 posts overall, including
860 high-agreement posts), report analysis-specific counts, and recheck the Abstract's
certainty findings. Do not relabel existing estimates as revised-sample
results.]}
...
In the broader certainty-annotated sample, AITA shows no clear descriptive
...
\textbf{[TODO: add the blaming/defending time-series figure with verified cohort counts and
...
In the broader certainty-annotated sample, blaming dissent in AITAH
...
In the earlier high-agreement joint trajectory analysis, AITAH contributed
$187$ NA-dominant posts and $15$ YA-dominant posts. These counts must be
updated when the analysis is rerun on the completed revised dataset. Directional comparisons
