...
The primary analysis uses all observed annotated comments in the low/high
...
This window is motivated by AITA's 18-hour verdict reference, not selected
to maximize separation between dissent directions. The restricted analysis
...
hold the post set fixed to first-18-hour contributors. Within high-agreement
