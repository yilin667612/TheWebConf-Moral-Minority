...
dataset. For certainty annotation, we randomly sample $1{,}400$ posts from AITA
and $700$ from AITAH, for a total of $2{,}100$ posts. In each community,
the sampling frame comprises posts with at least $200$ retained YA/NA verdict
comments ($\mathrm{YANA\_total}\ge200$). The high-agreement subset used in the joint share--certainty
...
from the broader annotated sample used for the first-24-hour comparison.
