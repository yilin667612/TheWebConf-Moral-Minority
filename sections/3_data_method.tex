...
submission containing a retained verdict tag. The main analyses include posts
...
\textbf{[TODO: specify tag extraction, including tag position, multiple or
quoted tags, and treatment of deleted text, bots, and unavailable authors;
...
dataset. Specifically, certainty annotations cover $2{,}100$ posts across the
two communities. The high-agreement subset used in the joint share--certainty
trajectory analysis contains $604$ posts: $331$ NA-dominant and $71$
YA-dominant posts in AITA, and $187$ NA-dominant and $15$ YA-dominant posts in
AITAH. Analyses of this subset are reported separately from analyses of the
broader certainty sample.
...
selection procedures, temporal coverage, and agreement/direction strata for
each analysis. Specify overlap among the three reply-pair samples and the
...
We group verdicts by whether they assign fault to the OP:
$\mathrm{YA}=\{\text{YTA},\text{YWBTA},\text{ESH}\}$ and
$\mathrm{NA}=\{\text{NTA},\text{YWNBTA},\text{NAH}\}$.
The hypothetical forms YWBTA and YWNBTA map to the same groups as YTA and NTA.
H-suffixed aliases in AITAH are normalized to their corresponding tags.
INFO is excluded because it requests information rather than expressing a
verdict. Appendix~\ref{sec:appendix-tags} lists the tags and their meanings.
...
human validation, and handling of multiple verdict tags in low-certainty
comments.]}
...
intervals for certainty. Its $604$-post high-agreement cohort is distinct
from the $2{,}100$-post sample used for the first-24-hour comparison.
