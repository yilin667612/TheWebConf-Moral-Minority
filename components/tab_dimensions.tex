\begin{table*}[t]
  ...
  \begin{tabular}{@{}p{0.16\textwidth}p{0.20\textwidth}p{0.58\textwidth}@{}}
    ...
    Expressed certainty & ordinal, $1$--$4$ & Annotated certainty of a verdict comment, from unresolved judgment ($1$) to a confidently asserted judgment ($4$); available in the $2{,}100$-post annotation sample and its specified subsets. \\
    \bottomrule
  \end{tabular}
  \caption{Analytical dimensions and measures.
